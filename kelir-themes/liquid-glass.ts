...
export const variants = {
  ...
  background:
    "radial-gradient(1200px 800px at 15% -10%, rgba(0, 102, 255, 0.35) 0%, transparent 55%), radial-gradient(1000px 700px at 110% 30%, rgba(0, 204, 255, 0.25) 0%, transparent 50%), linear-gradient(180deg, #12131A 0%, #0C0D14 100%)", // deep space-blue canvas
