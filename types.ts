...
import { NativeSelectProps as MuiNativeSelectProps } from "@mui/material/NativeSelect";
...
export type Theme = "neumorphism";
export type Font = "product-sans";
...
// 3. Alert Dialog
export interface AlertDialogProps extends Omit<MuiDialogProps, "open" | "title"> {
  open: boolean;
  title: React.ReactNode;
...
// 7. Badge
export interface BadgeProps extends Omit<MuiBadgeProps, "children" | "variant"> {
  children: React.ReactNode;
...
// 18. Combobox
export interface ComboboxProps extends Omit<MuiAutocompleteProps<any, any, any, any>, "renderInput"> {
  label?: string;
  placeholder?: string;
}
...
export interface CommandProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  groups: {
    heading: string;
    items: { label: string; value: string; icon?: React.ReactNode; onSelect?: () => void }[];
  }[];
}
...
// 26. Dropdown Menu
export interface DropdownMenuProps extends Omit<MuiMenuProps, "open" | "anchorEl"> {
  trigger: React.ReactNode;
...
// 61. Toggle Group
export interface ToggleGroupProps extends Omit<MuiToggleButtonGroupProps, "children"> {
...
export interface TypographyProps extends MuiTypographyProps {
  variant?: "h1" | "h2" | "body-md" | "label-caps" | any;
}
